...
var categoryGoodsListHandler = Handler(
  handlerFunc: (BuildContext context, Map<String, List<String>> paramerters) {
    var categoryName = FluroConvertUtil.fluroCnParamsDecode(paramerters["categoryName"].first);
    var categoryId  = int.parse(paramerters["categoryId"].first);

    print("categoryGoodsListHandler => categoryName = $categoryName  categoryId = $categoryId");
